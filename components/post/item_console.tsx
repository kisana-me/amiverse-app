...
export default function ItemConsole({ post }: { post: PostType }) {
  return (
    <View style={styles.container}>
      {/* Quote */}
      <TouchableOpacity style={styles.button}>
        <Svg viewBox="0 0 100 100" width={18} height={18} fill="currentColor" color="#666">
          <Path fillRule="evenodd" clipRule="evenodd" d="M44 20H11V56H35V71L29 71V80H44V20ZM89.0002 20H56.0002L56.0002 56H80.0002V71L74.0002 71V80H89.0002V20Z" />
        </Svg>
      ...
      {/* Diffuse */}
      <TouchableOpacity style={styles.button}>
        <Svg viewBox="0 0 100 100" width={18} height={18} fill="currentColor" color={post.is_diffused ? '#17bf63' : '#666'}>
        ...
        <ThemedText style={[styles.count, post.is_diffused && styles.diffusedCount]}>{post.diffuses_count || 0}</ThemedText>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.button}>
        ...
        <ThemedText style={styles.count}>{post.replies_count || 0}</ThemedText>
      </TouchableOpacity>
